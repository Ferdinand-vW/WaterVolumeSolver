...
/* package stopwatch-0.1.0.2 */
#define VERSION_stopwatch "0.1.0.2"
#define MIN_VERSION_stopwatch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_PACKAGE_KEY "Water_95FBMSur5uJLWmCvPCHuCl"
